                  ...
                  <Row className="align-items-center">
                    ...
                    >
                      <Col md="10" className="mx-auto">
                        ...
                        {errors.totalExperience?.type === "min" && (
                          <p className="text-danger">
                            <strong className="text-danger">
                              Loan can be availed only with minimum experience
                              of 1 year.
                            </strong>
                          </p>
                        )}
                        {errors.totalExperience?.type === "max" && (
                          <p className="text-danger">
                            <strong className="text-danger">
                              Max Experience allowed is 40 years
                            </strong>
                          </p>
                        )}
                        <FloatingLabel
                    ...
                    >
                      <Col md="10" className="mx-auto text-left">
                        <Form.Label
                          ...
                          className="text-left"
                        >
                          Upload two latest salary slip/current dated salary
                          certificate
                        </Form.Label>
                        <Form.Control
                          type="file"
